  ...
  return (
    <>
      ...
      <section className="section-block">
        <SectionTitle eyebrow="Explorá el portal" title="Seis formas de llegar mejor preparado" description="Cada sección resuelve una necesidad concreta. Entrá por donde más te sirva hoy." />
